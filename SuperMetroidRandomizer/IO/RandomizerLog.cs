...
namespace SuperMetroidRandomizer.IO
{
    public class RandomizerLog
    {
        ...
        public string GetLogOutput()
        {
            ...
            writer.AppendLine("Super Metroid: Project Base Randomizer Log");
            writer.AppendLine("----------------------------");
            ...
            writer.AppendLine();
            writer.AppendLine("Green Brinstar");
            writer.AppendLine("--------");
            foreach (var location in generatedItems.Where(x => x.Item.Type != ItemType.Nothing && x.Region == Region.GreenBrinstar))
            {
                writer.AppendLine(string.Format("{0}{1}", location.Name.PadRight(47, '.'), GetItemName(location.Item)));
            }
            writer.AppendLine();
            writer.AppendLine("Pink Brinstar");
            writer.AppendLine("--------");
            foreach (var location in generatedItems.Where(x => x.Item.Type != ItemType.Nothing && x.Region == Region.PinkBrinstar))
            {
                writer.AppendLine(string.Format("{0}{1}", location.Name.PadRight(47, '.'), GetItemName(location.Item)));
            }
            writer.AppendLine();
            writer.AppendLine("Red Brinstar");
            writer.AppendLine("--------");
            foreach (var location in generatedItems.Where(x => x.Item.Type != ItemType.Nothing && x.Region == Region.RedBrinstar))
            {  
                writer.AppendLine(string.Format("{0}{1}", location.Name.PadRight(47, '.'), GetItemName(location.Item)));
            }
            writer.AppendLine();
            writer.AppendLine("Kraid");
            writer.AppendLine("--------");
            foreach (var location in generatedItems.Where(x => x.Item.Type != ItemType.Nothing && x.Region == Region.Kraid))
            {            	
                writer.AppendLine(string.Format("{0}{1}", location.Name.PadRight(47, '.'), GetItemName(location.Item)));
            }
            writer.AppendLine();
