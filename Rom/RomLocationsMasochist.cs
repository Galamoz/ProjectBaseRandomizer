        	            ...
        	            && have.Contains(ItemType.MorphingBall))
                               ...
                               {           
                                   ...
                                   CanAccess =
									   ...
									   || (CanAccessRedBrinstar(have)
                                   	    && CanUsePowerBombs(have)),	
										//early xray strat with dboosts can require 1 extra etank from red tower to xray
										//returning to red tower may take 2 extra etanks
											//or go to pink brinstar
                               },
                           new Location
                               {           
                                   NoHidden = true,
                           ...
                           new Location
                               {                    
                                   ...
                                   CanAccess =
                                       have =>
                                   	CanAccessRedBrinstar(have)
									&& CanOpenMissileDoors(have), //no hellrun
                               },
                           new Location
                               {                   
                                   NoHidden = true,
                           ...
                           new Location
                               {                    
                                   ...
                                   CanAccess =
                                       have =>
                                       CanAccessRedBrinstar(have), //no hellrun
                               },
                           new Location
                               {                    
                                   NoHidden = false,
